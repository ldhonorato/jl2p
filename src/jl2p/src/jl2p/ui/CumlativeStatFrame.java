...
public class CumlativeStatFrame extends StatFrame implements ListSelectionListener
{
	...
	public static CumlativeStatFrame openWindow(java.util.List<Packet> packets,StatisticsTaker staker){
		CumlativeStatFrame frame=new CumlativeStatFrame(packets,staker);
		frame.setVisible(true);
		return frame;
	}
	
	CumlativeStatFrame(java.util.List<Packet> packets,StatisticsTaker staker){
