...
public class ApplicationProtocolStatistics extends Statistics {
	...
	public ApplicationProtocolStatistics() {
		analyzers = AnalyzerLoader.getAnalyzersOf(Analyzer.APPLICATION_LAYER);
	...
	public String getName() {
		return "Protocolo da camada de aplicação";
	}
